...
export const alternatives: Record<string, Alternative> = {
  "chatpdf": {
    ...
    comparison: [
      ...
      { feature: "Summary mode", pdfsum: "Yes", competitor: "Chat only", pdfsumWins: true },
      { feature: "Pro price/month", pdfsum: "$5", competitor: "$5", pdfsumWins: false },
      { feature: "Pro yearly", pdfsum: "$50", competitor: "$60", pdfsumWins: true },
    ...
    faqs: [
      ...
      { question: "Can PDFSum chat with PDFs like ChatPDF?", answer: "PDFSum focuses on generating structured summaries rather than chat. A Q&A feature is on the roadmap. For now, PDFSum produces higher-quality summaries than ChatPDF's chat mode." },
  ...
  "notion-ai": {
    ...
    faqs: [
      { question: "Is PDFSum cheaper than Notion AI?", answer: "Much cheaper. PDFSum is free to start (5 summaries/day). Notion AI costs $10 per member per month. PDFSum Pro is $5/month vs Notion AI's $10/member/month." },
  ...
  "pdf-ai": {
    ...
    whySwitch: [
      ...
      "Lower Pro pricing: $5/month vs PDF.ai's higher tiers",
    ],
    comparison: [
      ...
      { feature: "Developer API", pdfsum: "Yes", competitor: "No", pdfsumWins: true },
      { feature: "Streaming output", pdfsum: "Yes", competitor: "No", pdfsumWins: true },
      { feature: "Pro price/month", pdfsum: "$5", competitor: "$10+", pdfsumWins: true },
      { feature: "Pro yearly", pdfsum: "$50", competitor: "$100+", pdfsumWins: true },
  ...
  "updf": {
    ...
    comparison: [
      ...
      { feature: "Pro price/month", pdfsum: "$5", competitor: "$6", pdfsumWins: true },
  ...
  "smallpdf": {
    ...
    whySwitch: [
      ...
      "Lower cost: $5/month Pro vs Smallpdf's $12/month",
    ],
    comparison: [
      { feature: "Free tier", pdfsum: "5 summaries/day forever", competitor: "Trial only", pdfsumWins: true },
      { feature: "Pro price/month", pdfsum: "$5", competitor: "$12", pdfsumWins: true },
      { feature: "Pro yearly", pdfsum: "$50", competitor: "$108", pdfsumWins: true },
