...
export default function Navigation() {
  ...
  useEffect(() => {
    // Give Clerk time to initialize, but don't block if it fails
  ...
  // Try to get user status, but don't block if Clerk fails
  let user = null;
  try {
    ...
    console.log("Clerk not available:", e);
  }
    ...
    <nav className="bg-white border-b">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Auth Buttons - Simplified without Clerk blocking */}
...
// Safe UserButton wrapper with error handling
