      ...
      <main className="min-h-screen bg-white" id="main-content">
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="mb-16">
              <h3 className="text-2xl font-bold text-gray-900 text-center mb-10">{t("testimonials.title")}</h3>
              <div className="grid md:grid-cols-3 gap-6">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="bg-white border border-gray-200 p-6 rounded-2xl">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">&ldquo;{t(`testimonial${i}` as any)}&rdquo;</p>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center font-bold text-blue-600">
                        {t(`testimonial${i}Name` as any).charAt(0)}
                      </div>
                      <div>
                        <div className="font-semibold text-gray-900 text-sm">{t(`testimonial${i}Name` as any)}</div>
                        <div className="text-xs text-gray-500">{t(`testimonial${i}Role` as any)}</div>
                      </div>
                    </div>
                  </div>
                ))}
